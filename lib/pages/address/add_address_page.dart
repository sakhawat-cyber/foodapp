...
//in windows change the select and stateless to statefull alt + enter
// vs code in window change the select and stateless to statefull alt + .
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  margin: EdgeInsets.only(left: Dimensions.height20/5,
                      right: Dimensions.height20/5,
                  ...
                  children: [
                    ...
                    CameraPosition(target: _initialPosition, zoom: 17),
                      ...
                      onMapCreated: (GoogleMapController controllter){
                        locationController.setMapController(controllter);
