...
class LocationController extends GetxController implements GetxService{
  ...
  /*weather the user is in service zone or not*/
  bool _inZone = false;
  bool get inZone => _inZone;
  /*show int and hidign the button as the map loads*/
  ...
  Future<void> updatePosition(CameraPosition position, bool fromAdderss) async {
    if(_updateAdderssData){
      _loading = true;
      update();
      try{
        if(fromAdderss){
...
/*   await Future.delayed(const Duration(seconds: 2),(){
    ...
    /*for dibuging*/
    /*status code is 200 not  problem,
    404 problem is route,
    500 problem is server,
    403 problem is permision */
